...
public class Repository<T>(ApplicationDbContext context) : IRepository<T> where T : class
{
    ...
    public virtual async Task<int> CountAsync(Expression<Func<T, bool>>? predicate = null, CancellationToken ct = default) => predicate == null ? await DbSet.CountAsync(ct) : await DbSet.CountAsync(predicate, ct);
